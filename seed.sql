...
('E-commerce Mobile App', 'Modern e-commerce mobile app design with smooth animations and intuitive navigation patterns.', 'UI Design', 'Alex Rivera', '2025-11-20', ARRAY['mobile', 'e-commerce', 'app-design', 'animations'], NULL, '#f59e0b'),
...
-- Illustration
('Abstract Geometric Art', 'Bold abstract illustrations using geometric shapes, vibrant colors, and modern compositions.', 'Illustration', 'Yuki Tanaka', '2025-11-10', ARRAY['abstract', 'geometric', 'bold', 'colorful'], NULL, '#ea580c'),
...
('Abstract 3D Shapes', 'Smooth abstract 3D shapes with gradient materials and studio lighting for modern web design.', '3D Art', 'Render Lab', '2025-11-25', ARRAY['abstract', '3d', 'shapes', 'gradient'], NULL, '#f59e0b'),
...
-- Motion
('Loading Animation Pack', 'Smooth loading animations and spinners for web and mobile applications.', 'Motion', 'Animate Studio', '2025-12-12', ARRAY['loading', 'animation', 'spinner', 'web'], NULL, '#f59e0b'),
...
('Page Transition Effects', 'Beautiful page transition animations for single-page applications and websites.', 'Motion', 'Flow Design', '2025-10-22', ARRAY['transitions', 'page', 'spa', 'smooth'], NULL, '#ea580c'),
